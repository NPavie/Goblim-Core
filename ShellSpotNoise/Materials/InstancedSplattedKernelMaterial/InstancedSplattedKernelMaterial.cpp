...
InstancedSplattedKernelMaterial::InstancedSplattedKernelMaterial(std::string name, KernelList* kernelsToRender, GPUFBO* accumulatorFBO, GPUTexture* depthTex)
	: MaterialGL(name, "InstancedSplattedKernelMaterial")
{
	...
	fp_cameraPlanes = fp->uniforms()->getGPUvec2("cameraPlanes");
	...
	try{
		...
		pass2_fp_cameraPlanes =			pass2_fp->uniforms()->getGPUvec2("cameraPlanes");
...
InstancedSplattedKernelMaterial::~InstancedSplattedKernelMaterial()
{

}

void InstancedSplattedKernelMaterial::render(Node *o)
{
...
void InstancedSplattedKernelMaterial::update(Node *o, const int elapsedTime)
{
