...
{
	mat4 objectToScreenSpace;
	mat4 objectToCameraSpace;
	float f_Grid_height;
...
void main()
{
	...
	cameraToObjectSpace = inverse(objectToCameraSpace);

	// Rasterization
	gl_Position = (objectToScreenSpace * o_position);

	// TODO precompute slicing data in VertexShader
