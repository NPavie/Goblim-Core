...
class SplattedVolumetricKernelMaterial : public MaterialGL
{
public:
	SplattedVolumetricKernelMaterial(std::string name, KernelList* kernelsToRender, GPUFBO* accumulatorFBO, GPUTexture* depthTex);

	~SplattedVolumetricKernelMaterial();
