#include "Materials/SSNMaterial/SSNMaterial.h"
#include "Engine/OpenGL/ModelGL.h"

SSNMaterial::SSNMaterial(std::string name, KernelList* kernelsToRender, GPUFBO* accumulatorFBO, GPUTexture* depthTex)
	: MaterialGL(name, "SSNMaterial")
{
...
SSNMaterial::~SSNMaterial()
{

}

void SSNMaterial::render(Node *o)
{
...
void SSNMaterial::update(Node *o, const int elapsedTime)
{
...
void SSNMaterial::initPass1(GLProgram* vertexShader, GLProgram* fragmentShader)
{
	pass1 = new GLProgramPipeline("pass1");
	
	pass1_vu_CPU_MVP =				vertexShader->uniforms()->getGPUmat4("CPU_MVP");
	pass1_vu_grid_height =			vertexShader->uniforms()->getGPUfloat("f_Grid_height");
	pass1_vu_smp_densityMaps =		vertexShader->uniforms()->getGPUsampler("smp_densityMaps");
	pass1_vu_smp_scaleMaps =		vertexShader->uniforms()->getGPUsampler("smp_scaleMaps");
	pass1_vu_smp_distributionMaps = vertexShader->uniforms()->getGPUsampler("smp_distributionMaps");
	pass1_vu_smp_surfaceData =		vertexShader->uniforms()->getGPUsampler("smp_surfaceData");

	pass1_fu_objectToScreen =	fragmentShader->uniforms()->getGPUmat4("objectToScreen");
	pass1_fu_objectToCamera =	fragmentShader->uniforms()->getGPUmat4("objectToCamera");
	pass1_fu_objectToWorld =	fragmentShader->uniforms()->getGPUmat4("objectToWorld");

	// Retrieve samplers
	pass1_fu_smp_models =		fragmentShader->uniforms()->getGPUsampler("smp_models");
	pass1_fu_smp_depth =		fragmentShader->uniforms()->getGPUsampler("smp_depthBuffer");
