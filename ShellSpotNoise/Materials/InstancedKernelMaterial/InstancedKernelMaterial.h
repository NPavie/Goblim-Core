...
class InstancedKernelMaterial : public MaterialGL
{
public:
	InstancedKernelMaterial(std::string name, KernelList* kernelsToRender, GPUFBO* accumulatorFBO, GPUTexture* depthTex);
	
	~InstancedKernelMaterial();
