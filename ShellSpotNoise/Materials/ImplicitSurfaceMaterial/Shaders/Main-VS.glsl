...
out kernelProfile surfaceKernel_profile;
flat out int  surfaceKernel_textureID;
//out mat4 surfaceKernel_toObjectSpace;
//out mat4 surfaceKernel_toWorldSpace;
out mat4 surfaceKernel_toViewSpace;
//out mat4 surfaceKernel_fromObjectSpace;
//out mat4 surfaceKernel_fromWorldSpace;
//out mat4 surfaceKernel_fromViewSpace;
// Output : object surface information
out float surfacePoint_shellHeight;
out vec3 surfacePoint_position;
out vec3 surfacePoint_normale;
out vec3 surfacePoint_tangente;

flat out int isAValidKernel;
out vec4 kernelEvaluationPoint;

mat4 dummy_mat4 = mat4(1.0);
...
void main()
{
	...
	surfaceKernel_profile = Kernels[profileID];

	// index of kernel and cell
	int nbCellPerLine = int(surfaceKernel_profile.data[2].y);
	int kernelPerCell = int(surfaceKernel_profile.data[2].z);
	...
	bool isValid = getNewKernelToObjectSpace(
						profileID,
						objectToWorldSpace,							// Model matrix
						...
						f_Grid_height,								// Height of the grid
						...
						surfaceKernel_profile,
						surfaceKernel_textureID,
						dummy_mat4,
						dummy_mat4,
						...
						dummy_mat4,
						dummy_mat4,
						surfacePoint_shellHeight,
						surfacePoint_position,
						surfacePoint_normale,
						surfacePoint_tangente
						);

	isAValidKernel = isValid ? 0 : 1;
	...
	// Rasterization
	gl_Position = (Proj * surfaceKernel_toViewSpace * kernelEvaluationPoint);
